...
| 🤖 [ARIA Chatbot](https://shanujan.is-a.dev) <br>**Live AI assistant on my portfolio** <br>Gemini API integration with secure API proxying via Cloudflare Workers — running in production right now. <br>![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![Cloudflare](https://img.shields.io/badge/Cloudflare-F38020?style=flat-square&logo=cloudflare&logoColor=white) <br>🔗 **[Try it live →](https://shanujan.is-a.dev)** | 📊 [Loan Risk Predictor](https://github.com/shanujans/loan-risk-prediction) <br>**ML package published on PyPI** <br>Decision Tree model with 87.5% accuracy and CI/CD pipeline for automated publishing. <br>![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![scikit-learn](https://img.shields.io/badge/scikit--learn-F7931E?style=flat-square&logo=scikitlearn&logoColor=white) ![PyPI](https://img.shields.io/badge/PyPI-3775A9?style=flat-square&logo=pypi&logoColor=white) |
|---|---|
| ⚛️ [Quantum Insight Forge](https://github.com/shanujans/Quantum-Insight-Forge) <br>**AI app on Google AI Studio** <br>Combines quantum computing concepts with the Gemini model. <br>![Gemini](https://img.shields.io/badge/Gemini-8E75B2?style=flat-square&logo=googlegemini&logoColor=white) ![AI Studio](https://img.shields.io/badge/Google_AI_Studio-4285F4?style=flat-square&logo=google&logoColor=white) | 🏦 [AutoAI Loan Risk](https://github.com/shanujans/AutoAI-Loan-Risk-Predictor) <br>**IBM Watson Studio learning project** <br>AutoAI experiment with SnapML — 77% accuracy. Built to learn the AutoAI workflow. <br>![IBM](https://img.shields.io/badge/IBM_Watson-052FAD?style=flat-square&logo=ibm&logoColor=white) |
| 📤 [Telegram File Uploader](https://github.com/shanujans/telegram-uploader) <br>**Async bot with VirusTotal scanning** *(AI-assisted)* <br>Asynchronous Telegram bot that scans files before upload. <br>![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![AsyncIO](https://img.shields.io/badge/AsyncIO-2C5BB4?style=flat-square&logo=python&logoColor=white) | 🎓 [Student Management System](https://github.com/shanujans/Skills-International-Application) <br>**ESoft final year project** <br>C# desktop application with SQL Server backend. <br>![C#](https://img.shields.io/badge/C%23-512BD4?style=flat-square&logo=dotnet&logoColor=white) ![SQL Server](https://img.shields.io/badge/SQL_Server-CC2927?style=flat-square&logo=microsoftsqlserver&logoColor=white) |
