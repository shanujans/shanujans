<p align="center"><img src="assets/terminal-hero.svg" alt="shanujansh@github" width="717"/></p>
...
<p align="center"><img src="assets/terminal-meta.svg" alt="System Meta"/></p>

<img src="assets/bar-languages.svg" alt="$ which -a --languages"/>

<p align="center"><img src="assets/terminal-languages.svg" alt="Languages"/></p>

<img src="assets/bar-focus.svg" alt="$ focus --areas"/>

<p align="center"><img src="assets/terminal-focus.svg" alt="Focus Areas"/></p>
...
<p align="center"><img src="assets/terminal-stats.svg" alt="GitHub Stats"/></p>

<sub>This card is regenerated by <code>.github/workflows/refresh-terminal.yml</code> using live GitHub API data + the <code>last_known_loc</code> baseline in <code>scripts/terminal_data.json</code>. Each regeneration stamps <code>// last synced YYYY-MM-DD HH:MM UTC</code> at the bottom of the card.</sub>
...
<sub>⚠️ The three widgets above are rendered live by external services — their font is fixed there; only colors are matched to the terminal palette.</sub>
